function prodmat = dot_bspline(fdobj1, fdobj2, nderiv1, nderiv2)
...
polycoef1 = zeros(ninterval,norder1-nderiv1,nrep); 
for i = 1:nbasis1 
...
polycoef2 = zeros(ninterval,norder2-nderiv2,nrep); 
for i = 1:nbasis2 
...
for j = 1:ninterval
    ...
    power = delta;
    prodmati = zeros(nrep,1);
    for i=1:D        
        prodmati = prodmati + ...
            power.*diag(squeeze(polyprodmat(:,:,D-i+1)))./i;
        power = power*delta;
    end
