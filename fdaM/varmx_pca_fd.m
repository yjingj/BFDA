function  pcarotstr = varmx_pca_fd(pcastr, nharm, nx)
%  VARMX_PCA_FD  Apply varimax rotation to harmonics in a pca.fd object.
%  Arguments:
...
%  This version is identical to varmx_pca, and is included 
%  for compatibility with the corresponding R function.
