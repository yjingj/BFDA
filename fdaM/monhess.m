...
%  Arguments:
%  X      ... arguments at which function and derivatives are evaluated
%             x(1) must be at lower limit, and x(n) at upper limit.
%  WFD    ... a functional data object
%  Returns:
%  D2H  ... values of D2 h wrt c for only those pairs of bsplines
%           that overlap.  The number of columns of D2H is 
%                    NBASIS*NORDER - NORDER*(NORDER-1)/2
