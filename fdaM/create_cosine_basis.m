function basisobj = create_cosine_basis(rangeval, nbasis, period, ...
                                         dropind)
%CREATE_COSINE_BASIS  Creates a functional data basis using only the
%  constant and the cosine terms of the FOURIER BASIS.
%  Arguments ...
