function penaltymat = cosinepen(basisobj, Lfdobj)
%  COSINEPEN computes the fourier penalty matrix for penalty LFD.
%  Arguments:
...
if width/period == ratio && isinteger(Lfdobj)
    ...
    penaltymat = diag(cosinependiag(basisobj, nderiv));
