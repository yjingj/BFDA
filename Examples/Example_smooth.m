...
% call BFDA
[out_cgrid, out_regress, param ] = ...
    BFDA(GausFD_cgrid.Y, GausFD_cgrid.T, param);
...
param_uc = setOptions_bfda('smethod', 'bhm', 'cgrid', 0, 'mat', 1, 'M',...
    5000, 'Burnin', 2000, 'pace', 1);

[out_ucgrid, out_regress, param_uc] =  ...
    BFDA(GausFD_ucgrid.Y, GausFD_ucgrid.T, param_uc);
...
param_ns = setOptions_bfda('smethod', 'bhm', 'cgrid', 1, 'mat', 0, 'M',...
    5000, 'Burnin', 2000, 'pace', 1, 'ws', 1);

[out_cgrid_ns, out_regress, param_ns ] =  ...
    BFDA(GausFD_cgrid_ns.Y, GausFD_cgrid_ns.T, param_ns);
...
param_uc_ns = setOptions_bfda('smethod', 'bhm', 'cgrid', 0, 'mat', 0, ...
    'M', 5000, 'Burnin', 2000, 'pace', 1, 'ws', 0.01);

[out_ucgrid_ns, out_regress, param_uc_ns ] = ...
        BFDA(GausFD_ucgrid_ns.Y, GausFD_ucgrid_ns.T, param_uc_ns);
...
param_rgrid = setOptions_bfda('smethod', 'babf', 'cgrid', 0, 'mat', 1, ...
    'M', 5000, 'Burnin', 2000, 'm', m, 'eval_grid', pgrid, 'ws', 0.1);

% call BFDA
[out_rgrid, out_regress, param_rgrid]=  ...
    BFDA(GausFD_rgrid.Y, GausFD_rgrid.T, param_rgrid);
...
param_rgrid_ns = setOptions_bfda('smethod', 'babf', 'cgrid', 0, 'mat', ...
    0, 'M', 5000, 'Burnin', 2000, 'm', m, 'eval_grid', pgrid, 'ws', 0.1);

% call BFDA
[out_rgrid_ns, out_regress, param_rgrid_ns] =  ...
    BFDA(GausFD_rgrid_ns.Y, GausFD_rgrid_ns.T, param_rgrid_ns);
